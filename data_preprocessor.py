...
if __name__ == "__main__":
    ...
    #     fp.close()
    #     count += 1
    result_list = DataPreprocessor(video_db_path, user_db_path, title_feature_path, audio_feature_path).get_train_data_from_origin_file2(
        None, "/home/yuanjun/code/Bytedance_ICME_challenge/track2/track2_title.txt", None, None)
    count = 0
    for i in result_list:
        fp = open("/home/yuanjun/code/Bytedance_ICME_challenge/track2/submit_jsons/result_%s.json" % count, 'w')
        count += 1
        json.dump(i, fp)
        fp.close()
"""
